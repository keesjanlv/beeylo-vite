...
export const GiveawayPage: FC<GiveawayPageProps> = ({ onTabChange }) => {
    ...
    <div className="giveaway-content">
      ...
      {userData ? (
        ...
        <div className="login-prompt">
          <p>Please log in to see your stats and referral link.</p>
          <button 
  ...
  return (
    <div className="page-content giveaway-new-page">
      <div className="giveaway-new-container">
        {/* 2x2 Button Grid */}
        <div className="giveaway-button-grid">
          <button 
            className={`giveaway-grid-btn ${activeSection === 'rewards' ? 'active' : ''}`}
            onClick={() => setActiveSection('rewards')}
          >
            Rewards
          </button>
          <button 
            className={`giveaway-grid-btn ${activeSection === 'why' ? 'active' : ''}`}
            onClick={() => setActiveSection('why')}
          >
            Why
          </button>
          <button 
            className={`giveaway-grid-btn ${activeSection === 'steps' ? 'active' : ''}`}
            onClick={() => setActiveSection('steps')}
          >
            Steps
          </button>
          <button 
            className={`giveaway-grid-btn ${activeSection === 'share' ? 'active' : ''}`}
